...
- `/automation` ศูนย์อัตโนมัติ (Daily Action Digest, Approve Priority Queue, Tomorrow Plan, Winner Playbook, Weekly Review, Posting Hygiene, Results Intake, login status, morning/evening, import CSV/JSON, bulk approve, logs)
- `/products` เพิ่มสินค้า / สร้าง content pack
- `/calendar` ตารางโพสต์วันนี้ + คิว Approve + Approve / ข้าม
- `/results` กรอก views/clicks/orders/ค่าคอม + Results Intake + Winner Playbook + Weekly Review + Posting Hygiene + ดูวิเคราะห์
