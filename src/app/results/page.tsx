...
import { buildBenefitFitLab } from "@/lib/benefit-fit";
import { buildTrustFitLab } from "@/lib/trust-fit";
    ...
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        ...
        {benefitFitLab.counts.postsWithMetrics === 0 ? (
          <p className="text-xs text-[var(--ink-soft)]">
            กรอกเมตริกด้านล่างเพื่อจัดอันดับมุมประโยชน์ — ไม่ใช่การันตียอดขาย
          </p>
        ) : (
          <ul className="list-disc space-y-2 pl-5 text-xs text-[var(--ink-soft)]">
            {benefitFitLab.bands
      ...
      <section className="space-y-3">
        ...
        {trustFitLab.counts.postsWithMetrics === 0 ? (
          <p className="text-xs text-[var(--ink-soft)]">
            กรอกเมตริกด้านล่างเพื่อจัดอันดับมุมความเชื่อถือ — ไม่ใช่การันตียอดขาย
          </p>
        ) : (
          <ul className="list-disc space-y-2 pl-5 text-xs text-[var(--ink-soft)]">
            {trustFitLab.bands
