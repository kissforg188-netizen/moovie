...
import { explainScore, expectedCommissionBaht } from "@/lib/scoring";
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-[var(--ink-soft)]">
                    ...
                    /ชิ้น) · {product.category}
                  </p>
                  <p className="mt-1 max-w-xl text-xs text-[var(--ink-soft)]">
                    {explainScore(product, score)}
                  </p>
                </div>
